...
Due to the lack of maintainers and increased code complexity, ВНИМАНИЕ: branch2 - проект устарел, используйте [react-native-vision-camera](https://github.com/mrousavy/react-native-vision-camera).
