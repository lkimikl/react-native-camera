...
Due to the lack of maintainers and increased code complexity, react-native-camera (branch1 ver 1) рекомендуется заменить на [react-native-vision-camera](https://github.com/mrousavy/react-native-vision-camera).
